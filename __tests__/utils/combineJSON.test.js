  ...
  describe('combineJSON', () => {
    ...
    describe('custom parsers', () => {
      it('should support yaml.parse', () => {
        ...
        const output = combineJSON([`__tests__/__json_files/yaml.yaml`], false, null, parsers);
      ...
      it('should multiple parsers on the same file', () => {
        ...
        const output = combineJSON([`__tests__/__json_files/simple.json`], false, null, parsers);
